  ...
  return <><Header/><main>
    <section className="hero">
      <div className="hero-copy">
        ...
        <div className="hero-actions"><a className="button primary" href="tel:0814208815">Call 081 420 8815</a><a className="button secondary" href="/gallery">View our work</a></div>
    ...
    <section className="work-section"><div className="section-heading light"><div><small>RECENT WORK</small><h2>Built safely.<br/><em>Finished properly.</em></h2></div><div><p>See completed electrical, solar, security and automation work from the Adam Electrical team.</p><a href="/gallery">Explore the gallery →</a></div></div><GallerySlider/></section>
